...
the create form — the rail. The list of saved presets is dropped while there
are none, but *Save as new* is always there: hiding the whole rail until a
preset existed left no way to make the first one.
